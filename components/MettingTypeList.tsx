...
const MettingTypeList = () => {
  ...
  return (
      <section className='flex items-center justify-center gap-6'>
        <div className='flex flex-col items-center gap-2 cursor-pointer' onClick={() => handleClick('instant-meeting')}>
        ...
        <div className='flex flex-col items-center gap-2 cursor-pointer' onClick={() => router.push('/recordings')}>
